...
* TODO A [[https://en.wikipedia.org/wiki/Autodidacticism][Skills]] [[https://en.wikipedia.org/wiki/Spectrograph][Spectrograph]]
  ...
  + [[https://en.wikipedia.org/wiki/Alfred_Aho][A]][[https://en.wikipedia.org/wiki/Peter_J._Weinberger][w]][[https://en.wikipedia.org/wiki/Brian_Kernighan][k]]
  http://inst.eecs.berkeley.edu/~selfpace/sp.unix.stuff/awk.pdf
...
* TODO Pshycotherapy
The following is unedited and stright from the [[http://www.cs.cmu.edu/Groups/AI/areas/classics/eliza/emacs/doctor.el][Doctors]] mouth.
...
* TODO Disclaimer
  ...
  misunderstanding and miscommunication, and with an infinite fractal
