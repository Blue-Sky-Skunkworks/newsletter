...
* TODO Transportation Hackathons Around the World
** Hack the Commute
   ...
   user-centric tools that improve the commute. These can take the
   form of:
   ...
   judges, with the top three project ideas moving on to a
   championship round. Work will be judged based on its potential to
   make commuting in Seattle easier and more pleasant for everyone.

** Princton
   http://www.princeton.edu/engineering/news/archive/?id=16368
   ...
   transportation policy, [[http://www.princeton.edu/][Princeton University]] professor [[http://chemists.princeton.edu/chan/][Garnet Chan]]
   told an audience during the hackathon sponsored by the [[https://citp.princeton.edu/][Center for
   Information Technology Policy (CITP)]] and [[http://codeforprinceton.org/][Code for Princeton]] on
   February 27 and 28.

   In an intensive 48 hours of coding, Chan and two partners created
   just such an app. The team's project, "Save Your Car," was one of
   four that won recognition at the hackathon, an event that attracted
   about 90 computer coders, policy enthusiasts, and interested
   citizens – from Princeton students and faculty to local middle
   school students. Teams spent the weekend in Sherrerd Hall
   brainstorming and creating digital technologies to solve
   transportation problems. Participants also could join
   transportation policy discussions and introductory coding
   tutorials.
...
* DONE Disclaimer
  ...
  other, out [[http://eoimages.gsfc.nasa.gov/images/imagerecords/79000/79787/city_lights_namerica_8k.jpg][here]] in the [[http://hermes.ffn.ub.es/luisnavarro/nuevo_maletin/Feynman_QED_1949.pdf][field]], doing what we do best — Hacking.
* DONE [[http://deoxy.org/iching][The Oracle]]
#+BEGIN_EXAMPLE
䷊  Peace
䷆  The Army
#+END_EXAMPLE
