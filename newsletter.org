...
* Carnival!!!
  ...
  [[https://en.wikipedia.org/wiki/AWK][skills]] and [[http://www.oikos.org/stepsintro.htm][thrills]], connection and conversation, [[https://en.wikipedia.org/wiki/Starship_Troopers][Starship Troopers]]
  and [[https://en.wikipedia.org/wiki/Ender%27s_Game][Ender's Game]] re-enacted using miniature [[https://en.wikipedia.org/wiki/Braitenberg_vehicle][Braitenberg vehicles]]
  ...
  You participate in our activities by showing up. We all love this
  stuff, but the modern world demands its high tax on the true wealths
  of this world, one being time and, if this song is close enough to
  your own personal song to join this choir, and you have that
  precious time to spare, come be awkward with the rest of us “nerds”
  — as we hack this world for the better together.
...
* Prizes Worth Hacking For
  ...
  would teach any programmer, beginning and seasoned, much if they
  were to explore it fully.  The entire well-commented assembly
  listing is included.
...
* Learning from “Old” Byte Magazines
...
#+END_EXAMPLE
    ...
    *hack*
    ...
    And if we now turn to the trusty [[http://www.catb.org/jargon/html/][Jargon File]] for some additional
    clarification:
...
E-Cycling]], out near the airport, who are busy keeping Missoula's aging
...
[[http://www.thinkwiki.org/wiki/Category:T500][ThinkpadT500]] yesterday to a "charging 0.1%" and now, as I pull the
...
* The Missoula Civic Hackathon as a possible example of a Hack
...
#+RESULTS:
: gregorian — Tue Jun  7 19:51:58 2016
: mayan — Long count = 13.0.3.9.4; tzolkin = 7 Kan; haab = 7 Zotz
: hebrew — Sivan 1, 5776
: french — 20 Prairial an 224 de la Révolution
...
* Transportation Hackathons Around the World
** Hack the Commute
